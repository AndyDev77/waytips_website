...
<body>
    ...
    <section class="img-background">
        <div class="color-overlay d-flex justify-content-center align-items-center">
            <h1 style="font-size: 4rem;">Ajouter un utilisateur</h1>
        </div>
    </section>
    ...
    <section class="form__section">
        <div class="container form__section-container">
            ...
            <?php endif ?>
            <form action="<?= ROOT_URL ?>admin/add-user-logic.php" class="form-sign" enctype="multipart/form-data" method="POST">
                ...
                <div class="about-btn row justify-content-center">
                    <button type="submit" name="submit" class="btn btn-2">Ajouter un utilisateur</button>
                </div>
